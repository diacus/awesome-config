...
-- attach nord colors to GTK

theme.gtk.bg_color = theme.nord0
theme.gtk.fg_color = theme.nord4

theme.gtk.menubar_bg_color = theme.nord0
theme.gtk.menubar_fg_color = theme.nord4

theme.gtk.selected_bg_color = theme.nord3
theme.gtk.selected_fg_color = theme.nord6

theme.gtk.error_bg_color = theme.nord11
theme.gtk.error_fg_color = theme.nord4

theme.gtk.wm_border_unfocused_color = theme.nord3
theme.gtk.wm_border_focused_color = theme.nord12
theme.gtk.success_color = theme.nord10
...
-- Generate wallpaper:
local wallpaper_bg = theme.nord0
